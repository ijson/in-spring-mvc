...
public class NumberUtils {
	...
	static final String FMT_DECIMAL_PART_NOZERO = "##########";// 小数部分，非必须 十位

	static final String FMT_DECIMAL_PART_ZERO = "0000000000";// 小数部分，十位
	...
	public static long getLong(String str, long defaultValue) {
		...
		return null == l ? defaultValue : l.longValue();
	}
