 ...
 **/
INTools.showProcess = function (msg) {
 ...
 **/
INTools.enableButton = function (selector) {
 ...
 * @param selector jquery选择器
 **/
INTools.disableButton = function (selector) {
 ...
 * @param selVl 值
 */
INTools.initRadio = function (elemname, selVl) {
 ...
 * @param selVl 值
 */
INTools.initSelect = function (elemid, selVl) {
 ...
 * @return 选中的text
 */
INTools.getSelectTextById = function (id) {
    if (INTools.getSelectValueById(id) != '') {
 ...
 * @return 选中的value
 */
INTools.getSelectValueById = function (id) {
 ...
 */
INTools.showMsg = function (titleStr, msgStr, heightStr, widthStr, timeoutStr, showtypeStr) {
    /**
